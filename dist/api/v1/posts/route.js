...
router.post('/', [AuthMiddleware_1.isUserAuth, FileUploadMiddleware_1.default.any()], PostController.insert);
...
router.put('/', [AuthMiddleware_1.isUserAuth, FileUploadMiddleware_1.default.any()], PostController.update);
router.delete('/', AuthMiddleware_1.isUserAuth, PostController.deletePost);
router.post('/temp', [AuthMiddleware_1.isUserAuth, FileUploadMiddleware_1.default.any()], PostController.insert);
