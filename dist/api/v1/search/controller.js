...
exports.searchCount = exports.searchArchived = exports.search = void 0;
...
const searchCount = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const totalPosts = yield (0, service_2.searchPostCount)(city, stateId, propertyId, categoryId);
