...
const saveTransaction = (payload, postInfo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (status === 'created') {
        const slackMsg = `Payment created - ${(user === null || user === void 0 ? void 0 : user.phone) ? `<https://wa.me/965${user === null || user === void 0 ? void 0 : user.phone}|${user === null || user === void 0 ? void 0 : user.phone}>` : ''} - ${(user === null || user === void 0 ? void 0 : user.admin_comment) ? `${user.admin_comment}` : ''}\n${title ? `${title} - ` : ''}${packageTitle} - ${amount}`;
...
const editTransaction = (trackId, reference_id, tran_id, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const slackMsg = `Payment ${status} - ${(user === null || user === void 0 ? void 0 : user.phone) ? `<https://wa.me/965${user === null || user === void 0 ? void 0 : user.phone}|${user === null || user === void 0 ? void 0 : user.phone}>` : ''} - ${(user === null || user === void 0 ? void 0 : user.admin_comment) ? `${user.admin_comment}` : ''}\n${transactionObj.package_title} - ${transactionObj.amount}`;
    yield (0, slackUtils_1.alertOnSlack)('imp', slackMsg);
...
const editTransactionStatus = (trackId, status) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const slackMsg = `Payment canceled - ${user.phone ? `<https://wa.me/965${user === null || user === void 0 ? void 0 : user.phone}|${user === null || user === void 0 ? void 0 : user.phone}>` : ''} - ${user.admin_comment || ''}\n${transaction.package_title} - ${transaction.amount}`;
